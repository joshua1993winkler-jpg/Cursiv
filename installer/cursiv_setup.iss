; ============================================================
; Cursiv v3.14-U06 — Eye of Horus terminal opens when you type 'cursiv'
; Produces: installer\Output\Cursiv-Setup-3.14-U06.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U06
