...
:: Compiles installer\cursiv_setup.iss into Cursiv-Setup-3.14-U06.exe
...
:: ---- Verify output -----------------------------------------
if not exist "installer\Output\Cursiv-Setup-3.14-U06.exe" (
    echo [ERROR] Installer not found at installer\Output\Cursiv-Setup-3.14-U06.exe
    pause & exit /b 1
)

echo.
echo  Installer created!
echo  File: installer\Output\Cursiv-Setup-3.14-U06.exe
echo.
pause
