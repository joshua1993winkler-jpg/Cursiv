...
:: Compiles installer\cursiv_setup.iss into Cursiv-Setup-3.14-U05.exe
...
:: ---- Verify output -----------------------------------------
if not exist "installer\Output\Cursiv-Setup-3.14-U05.exe" (
    echo [ERROR] Installer not found at installer\Output\Cursiv-Setup-3.14-U05.exe
    pause & exit /b 1
)

echo.
echo  Installer created!
echo  File: installer\Output\Cursiv-Setup-3.14-U05.exe
echo.
pause
